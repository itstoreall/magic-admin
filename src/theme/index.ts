...
export const contrastLight = '#e36858';
export const contrastLightHover = '#de4444';
export const contrastDark = '#96abad';
export const contrastDarkHover = '#66a5ac';
